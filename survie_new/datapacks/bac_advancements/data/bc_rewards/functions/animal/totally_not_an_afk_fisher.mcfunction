...
execute if score trophy bac_settings matches 1 run give @s minecraft:fishing_rod{CustomModelData:131,HideFlags:70,Unbreakable:0,Enchantments:[{id:"minecraft:unbreaking",lvl:3}],display:{Name:"{\"italic\":\"false\",\"bold\":\"true\",\"color\":\"#6B9F93\",\"translate\":\"Super Rod\"}",Lore:["{\"color\":\"#6B9F93\",\"translate\":\"Catches the best pokemon from the seas\"}","{\"text\":\" \"}","{\"color\":\"gray\",\"translate\":\"Awarded for achieving\"}","{\"italic\":\"false\",\"color\":\"light_purple\",\"translate\":\"Totally not an AFK fisher!\"}"]}} 1
