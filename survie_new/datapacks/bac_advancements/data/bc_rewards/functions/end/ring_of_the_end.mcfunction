...
execute if score trophy bac_settings matches 1 run give @s minecraft:ender_eye{Enchantments:[{id:"minecraft:unbreaking",lvl:1}],CustomModelData:131,HideFlags:33,display:{Name:"{\"italic\":\"false\",\"bold\":\"true\",\"color\":\"#EEF6B4\",\"translate\":\"Ring of Bedrock\"}",Lore:["{\"color\":\"#EEF6B4\",\"translate\":\"The end of the End\"}","{\"text\":\" \"}","{\"color\":\"gray\",\"translate\":\"Awarded for achieving\"}","{\"italic\":\"false\",\"color\":\"light_purple\",\"translate\":\"Ring of the End\"}","{\"text\":\" \"}","{\"color\":\"gray\",\"translate\":\"Awarded for achieving\"}","{\"italic\":\"false\",\"color\":\"light_purple\",\"translate\":\"Ring of the End\"}"]}} 1
